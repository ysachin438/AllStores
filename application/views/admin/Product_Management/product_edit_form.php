<div class="card card-info card-outline mb-4">
    ...
    <div class="card-header">
        <div class="card-title"><h3><?php echo $item['name']?></h3></div>
    </div>
    <!--end::Header-->
    <!--begin::Form-->
    <form class="needs-validation" action="<?php echo base_url('index.php/admin/editItemAuth/'.$item['pid']) ?>" method="post" novalidate>
        <!--begin::Body-->
        <div class="card-body">
            <!--begin::Row-->
            <div class="row g-3">
